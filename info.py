...
USERNAME = environ.get('USERNAME', "https://t.me/icrunchbot") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002652695292'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/iPapkorn4')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Mk_bot_Support') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("FQDN", "https://prepared-cookie-telegram-features-e9b7ed11.koyeb.app/")
